...
%%%
%%% @end
%%% Created : 10 Jul 2010 by ytakano <ytakano@gmail.com>
%%%-------------------------------------------------------------------
-module(dnndbh).
...
create(Server, File) ->
    gen_server:cast(Server, {create, File}).
...
%% @end
%%--------------------------------------------------------------------
handle_cast({create, File}, State) ->
    create_dbh(State#state.port, File),
    {noreply, State};
